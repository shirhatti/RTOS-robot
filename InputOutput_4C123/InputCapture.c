...
//	GPIO_PORTB_DIR_R &= ~0xF3;       // make PB6 in
//  GPIO_PORTB_AFSEL_R |= 0xF3;      // enable alt funct on PB6
//  GPIO_PORTB_DEN_R |= 0xF3;        // enable digital I/O on PB6
//                                   // configure PB6 as T0CCP0
//  GPIO_PORTB_PCTL_R = (GPIO_PORTB_PCTL_R&0x0000FF00)+0x77770077;
//  GPIO_PORTB_AMSEL_R &= ~0xFF;     // disable analog functionality on PB6
		
	GPIO_PORTB_DIR_R &= ~0x30;       // make PB6 in
  GPIO_PORTB_AFSEL_R |= 0x30;      // enable alt funct on PB6
