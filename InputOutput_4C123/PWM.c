...
//PD0,PD1 go to right motor
//PD2,PD3 go to left
void PortB_Init(void){ 
	
	unsigned long volatile delay;
	SYSCTL_RCGCGPIO_R  |= SYSCTL_RCGC2_GPIOB;       // activate port D
  delay = SYSCTL_RCGC2_R;        
  delay = SYSCTL_RCGC2_R;         
  GPIO_PORTB_DIR_R |= 0x03;    // make PE6-0 output heartbeats
  GPIO_PORTB_AFSEL_R &= ~0x03;   // disable alt funct on PE6-0
  GPIO_PORTB_DEN_R |= 0x03;     // enable digital I/O on PE6-0
  //GPIO_PORTB_PCTL_R = ~0x00003;
  GPIO_PORTB_AMSEL_R &= ~0x03;;      // disable analog functionality on PE
}
...
//MotorR and MotorL are numbers between 0 and 80000
